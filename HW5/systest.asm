...
;     1/17/18  Glen George      Updated comments.
;     2/28/19  Bobby Abrahamson Added tests for MUL, IO, NOP instructions.
...
TestSkips:                              ; test skip instructions
		...
		JMP     TestMultiplication      ; test extra credit instructions
...
TestIOInstructions:
        ...
        JMP     TestNops                ; Test NOPs

TestMultiplication:
		LDI     R22, $80           
		LDI     R23, $02
		MUL     R23, R22                ; test multiplication 2 * 80
		MUL     R22, R23                ; test for commutativity of mul
		LDI     R22, $FF
		LDI     R23, $FF 
		MUL     R23, R22                ; test for 0xFF * 0xFF
        JMP     TestIOInstructions
